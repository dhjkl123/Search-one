...
public class BoardController {
    ...
    @GetMapping("/{docId}")
    public ResponseEntity<?> getOneBoard(@PathVariable("docId") String docId) throws ExecutionException, InterruptedException{
        BoardResponseDto boards = boardService.getPost(docId);
